...
## TCP滑动窗口
滑动窗口表示发送窗口和接受窗口，其可以实现流量控制。而所谓的流量控制就是让发送方的发送速率不要太快，让接受f来得及接受
...
8. A发送序号为301到400的字节简单来说就是这样的，至于传输效率和拥塞控制，那就是另外的事情了。
![图解](https://pic3.zhimg.com/50/581b2c3e8d974af3081477eb6ee62d86_hd.jpg)
